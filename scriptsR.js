...
/* Event listener para procesar el formulario de la ruta */
...
document.getElementById("rutaForm").addEventListener("submit", function(event) {
  ...
  var trayectoria = JSON.parse(document.getElementById("trayectoria").value);

  // Realizar acciones con los datos ingresados, como enviarlos al servidor o procesarlos localmente

  // Cerrar la ventana emergente
  document.getElementById("rutaPopup").style.display = "none";
});
